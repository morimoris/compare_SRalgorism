...
from tensorflow.python.keras.layers import Conv2D, Conv2DTranspose, Input, Add, Multiply, Concatenate, Average, Lambda, ReLU, BatchNormalization
import MyPReLU
...
class Single_SR():
    ...
    def DRRN(self, recursive_brocks = 1, recursive_units = 25, filter_num = 128, filter_size = (3, 3)): 
        """
        ...
        #output conv2d
        conv2d_out = Conv2D(filters = self.input_channels, kernel_size = filter_size, padding = "same")(add_conv)
...
class Video_SR():
    ...
    def VESPCN(self, input_LR_num = 3): #main
        ...
        #upsampling
        ESPCN_input = [I_t_minus_1, input_list[1], I_t_plus_1]
